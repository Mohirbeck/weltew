                ...
                <nav className="flex flex-col lg:flex-row space-y-12 lg:space-y-0 justify-between">
                    ...
                    <div>
                        ...
                        <div className="flex items-center space-x-2 mt-3">
                            <a href="https://instagram.com/" className="rounded-full aspect-square w-9 flex items-center justify-center bg-[#d02d8b] hover:-translate-y-2 transition duration-300">
                            ...
                            <a href="https://t.me/" className="rounded-full aspect-square w-9 flex items-center justify-center bg-[#29b6f6] hover:-translate-y-2 transition duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 stroke-white stroke-2 fill-white"
                                    viewBox="0 0 50 50">
