            ...
            <div className='mt-16'>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-4 mt-4'>
                <div className='lg:col-span-3'>
                  <div className='w-full aspect-video flex justify-center items-center group bg-center bg-no-repeat bg-cover cursor-pointer' onClick={() => setVideoOpen(true)} style={{ backgroundImage: `url(${youtube.cover})` }}>
      ...
      {videoOpen && (
        <div className='fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-50 flex justify-center items-center'>
          <div className='flex justify-center items-center w-4/5 h-4/5'>
            <iframe src={youtube.link} className='w-full h-full' allowFullScreen frameBorder="0"></iframe>
          </div>
          <div className='absolute top-0 right-0 mt-4 mr-4'>
            <button onClick={() => setVideoOpen(false)} className='w-8 h-8 bg-white rounded-full flex justify-center items-center'>
